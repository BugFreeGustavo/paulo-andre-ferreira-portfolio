export const projects = [
    // Cinema / Vimeo
    {
        ...
        credits: "FOTOGRAFIA // PHOTOGRAPHY: Miguel Manso (A.I.P.)" +
            "ARGUMENTO E DIÁLOGOS // SCREENPLAY // GUIÃO // SCRIPT: Paulo André Ferreira PROTAGONISTAS // STARRING // Lúcia Moniz, Rita Tristão, Romeu Vala, Margarida Cardoso, Daniela Cabaças " +
            "COMPOSITOR MUSICAL // MUSIC COMPOSER: Eduardo Queiroz " +
            "CRIAÇÃO GRÁFICA // GRAPHICS: Dário Gomes " +
            "DIRETOR DE SOM // SOM DIRECTOR: Miguel Ângelo Moita " +
            "PÓS PRODUÇÃO ÁUDIO // AUDIO POST-PRODUCTION: Martim Crawford " +
            "MONTAGEM // EDITING // COLORISTA // GRADING : Filipe Pinto Silva PRODUTOR // PRODUCER: Paulo André Ferreira " +
            "CHEFE DE PRODUÇÃO // PRODUCTION MANAGER: Mónica Mota " +
            "ANOTAÇÃO // SCRIPT SUPERVISOR: Fábio Freitas " +
            "DIRECÇÃO DE ACTORES // ACTING COACH: Marco Medeiros " +
            "ASSISTENTE DE REALIZAÇÃO // ASSISTANT DIRECTOR: Luís Rafael Coelho " +
            "OPERADOR DE CÂMARA // CAMERA OPERATOR: Emanuel Garcia " +
            "1º ASSISTENTE DE IMAGEM // 1ST ASSISTANT CAMERA: Ricardo Capucha " +
            "DIRECÇÃO DE ARTE // PRODUCTION DESIGNER / ART DIRECTOR: Margarida Simões FIGURINOS // COSTUME DESIGNER: Margarida Simões " +
    ...
    // RTP Play
    {
        ...
        credits: "Realização" +
            ...
            "2023" +
            "" +
            "Cinematographer Miguel Manso " +
            "Composer José de Castro" +
            "sound editor Martim Crawford " +
            "sound recordist Miguel Ângelo Moita " +
            "Editing António Forte " +
            "Junior Editor André Valente Franco " +
            "vfx design Luís Guerreiro " +
            "colorist Filipe Pinto Silva " +
            "Art Director Margarida Guigas Simões " +
            "head of production Pedro MR Duarte " +
            "production manager Mariana Neto " +
            "assistant production manager Teresa Teixeira" +
            "first Assistant Director Mónica Teotónio Pereira  " +
            "Illustrator Margarida Guerra Dias " +
            "Graphical designer Dário Gomes " +
            "props Tiago Tomaz Rosa " +
            "Sound assistent Tiago Dias Sound " +
            "Drone Operator Frederico Borges " +
            "assistant camera Ricardo Gonçalves " +
            "Gaffer Marcio Pratas " +
    ...
    // Music Videos / Vimeo
    {
        ...
        credits: ":: música ::" +
            "Música e letra - Nena" +
            "Produção - João André" +
            "Produção vocal e arranjo - João André, Diana Martinez, Nena." +
            "Voz - Nena" +
            "Coros - Diana Martinez, Nena" +
            "Guitarra acústica - Feodor Bivol, Nena" +
            "Guitarra elétrica - Ivo Magalhães" +
            "Piano e Synths - Rebeca Miranda" +
            "Synths, programações, percussões - João André" +
            "Baixo - Pedro Santos" +
            "Bateria - Miguel Casais" +
            "Assistentes de produção - Pedro Pulga, Caetana Aguiar" +
            "Mistura - João André" +
            "Masterização  - Mário Barreiros" +
            "" +
            "Gravado entre abril e maio de 2023 nos estúdios SoundHill, Plateia D’Ilusões e Groovewood studios." +
            "" +
            ":: vídeo ::" +
            "Realizado por Paulo André Ferreira" +
            "Diretor de Fotografia - João Gomes" +
            "Diretora de Arte - Guigas Simões" +
            "Anotadora - Patrícia Franco" +
            "Assistente de Realização - Joana Linhares" +
            "Operador de Gimbal - Carlos Queiroz" +
            "Handycam - Joana Linhares e Mónica TP" +
            "Focus Puller - Pedro Cavaco" +
            "Assistente de Iluminação - Pedro Cardoso" +
            "Assistente de Iluminação - Joana Campos" +
            "Editor - André Costa" +
            "Correção de Cor - Filipe Pinto " +
            "Assistente de Arte - Tiago Jamaica" +
            "Aderecista - Miguel Preto" +
            "Coreógrafa - Catarina Amaral" +
            "Stylist - Mia Lourenço " +
            "Assistente de Stylist - Maria Inês Santos" +
            "Make-up e Cabelos - Cátia Bolota" +
            "Produzido por Mar Geada e Mónica TP" +
            "Produção Executica - Estúdio Zeco" +
            "" +
    ...
    },
    {
        ...
        description: "",
        credits: "Letra e Música: Cuca Roseta" +
            "Produção: Francisco Sales" +
            "Musicos: " +
            "Sandro Costa (guitarra portuguesa)" +
            "Francisco Sales (guitarra clássica)" +
            "Marino Freitas (baixo acustico)" +
            "Vicky Marques (bateria)" +
            "Iuri Oliveira (percussão)" +
            "Sandra Martins (violoncelo) " +
            "" +
            "Gravado nos Slow Music Studios " +
            "Capturado e Misturado por Nuno Simões" +
            "" +
            ...
            "Director de fotografia: Miguel Manso" +
            "Diretora de Arte: Margarida Dias" +
            "Operador de câmara: Ricardo Correia" +
            "Assistente de imagem: Ricardo Capucha" +
            "Assistente de imagem: Ricardo Gonçalves " +
            "Pós-Produção Áudio - Gustavo Marques" +
            "Gaffer: Márcio Pratas" +
            "Editor: André Costa" +
            "Grading: Filipe Pinto Silva" +
            "Make-up: Cristina Gomes " +
            "Hair Stylist: David Xavier  " +
            "Stylist: Mia Lourenço " +
            "Produzido por Mar Geada / Mónica TP" +
            "" +
            "" +
    ...
    },
    {
        ...
        description: "",
        credits: "Composição - NAPA" +
            "Letra - Guilherme Gomes" +
            "Voz - Guilherme Gomes" +
            "Bateria - Tiago Rodrigues" +
            "Baixo - João Rodrigues" +
            "Guitarras - Francisco Sousa / Guilherme Gomes" +
            "" +
            "Gravado em Sintra, no BlackSheep Studios" +
            "Captação de som - Francisco Dias Pereira e Bruno Xisto" +
            "Mistura - Francisco Dias Pereira" +
            "Masterização - Guilherme Gonçalves" +
            "" +
            "Realizador - Paulo André Ferreira  " +
            "DoP/Grading - Filipe Pinto Silva  " +
            "Operador Gimbal - Emanuel Garcia  " +
            "1° assistente de imagem - Filipe Brito  " +
    ...
    },
    {
        ...
        description: "",
        credits: "Letra: Mónica Teotónio e João Só" +
            "Música: João Só" +
            "" +
            ...
            "Músicos:" +
            "" +
            "Rui Ribeiro: Piano e arranjo de cordas" +
            "Nuno Simões: Baixo" +
            "Ana Mariano: Coros" +
            "Sara Cruz: Coros" +
            "João Só: Bateria, programações, percussão, teclados, guitarra acústica, guitarra eléctrica e coros" +
            "Mónica Teotónio: Voz" +
            "" +
            "Video:" +
            "" +
            ...
            "Editor: André Costa" +
            "Grading: Filipe Pinto Silva" +
            "Pós Produção Audio: Gustavo Marques" +
            "Assistente de produção: Francisca Geada" +
            "Mua: Mariana Palaio" +
            "Hair stylist: Madmoiselle" +
            "Stylist: Sara Peterson" +
            "Making of: Joana Campos" +
            "Fotógrafo de cena: Fiti" +
            "Produção: Mar Geada & Mónica Teotónio" +
    ...
    },
    {
        ...
        description: "",
        credits: "Barbante: André Goes, André Rosado, Gustavo Marques, Paulo André Ferreira" +
            "" +
            "PATAMAR:" +
            "" +
            "André Goes – Voz e Baixo " +
            "André Rosado – Guitarra" +
            "Paulo André Ferreira – Bateria " +
            "Gustavo Marques – Guitarra" +
            " " +
            "Letra e Composição Barbante" +
            " " +
            "Gravado, misturado e masterizado por André Pinheiro e Ricardo Mealha, no estúdio: Complexo1025" +
            "Produzido por André Pinheiro, Ricardo Mealha e Barbante." +
            " " +
            "Produção - Barbante" +
            "Realização - Paulo André Ferreira" +
    ...
    },
    {
        ...
        credits: "Barbante: André Goes, André Rosado, Gustavo Marques, Paulo André Ferreira" +
            "" +
            "ADEUS:" +
            "André Goes – Voz e Guitarra" +
            "André Rosado – Baixo" +
            "Paulo André Ferreira – Bateria " +
            "Pedro Sousa – Rajão e Voz" +
            " " +
            "Letra: Pedro Sousa" +
            "Composição: Barbante" +
            " " +
            ...
            "Realização - Paulo André Ferreira" +
            "Director de Fotografia / Grading - Filipe Pinto Silva" +
            "Ass. de Realização - Álvaro Candeias" +
            "Steadycam - Emanuel Garcia" +
    ...
    },
    {
        ...
        description: "",
        credits: "Realização: Paulo André Ferreira" +
            "Assistente de Realização: Álvaro Candeias" +
            "Director de Fotografia / Color Grading: Filipe Pinto Silva" +
            "Edição: André Rosado" +
            "Efeitos Visuais: Luís Rodrigues" +
            "Pós-produção áudio: Martim Crawford" +
            "Produção: Fábio Freitas" +
            "Assistente de Produção: André Goes, Filipe Tavares" +
            "Direcção de Actores: Pedro Sousa" +
            "Maquilhagem: Catarina Santiago" +
            "Chefe Guarda-Roupa: Catarina Gomes" +
            "Fotógrafo de cena: Dário Gomes" +
            "" +
            "Com: " +
            "Dalí (Cão)" +
            "Filipe Tavares" +
    ...
    },
    {
        ...
        description: "",
        credits: "Video made by:" +
            "Director - Paulo André Ferreira" +
            "DOP - Telmo Domingues" +
            "Editor/Grading - André Rosado" +
            "" +
            "Record, Mix, Master:" +
            "Martin Colmant aka AYEMA" +
    ...
    },
    {
        ...
        description: "",
        credits: "com Ana Manana & Miguel Amorim" +
            "" +
            "Realização: Paulo André Ferreira" +
            "Direcção de Fotografia: Frederico Borges" +
            "Anotação: Joana Marcelino" +
            "Caracterização: Sara Daniela Reis" +
            "Direcção de Arte: Mónica Teotónio & Martim Baginha" +
